...
if (require.main === module) {
    ...
    // Uncomment below for waiting for input
    // process.stdin.once('data', () => {});

    const args = process.argv.slice(2);
    if (args.length < 3) {
        console.log(INFO_CONSOLE_BOLD_TEXT + "Insufficient arguments. Usage: app module_name broker_port(60000) listen_port(60003)" + NORMAL_CONSOLE_TEXT);
        process.exit(1);
    }
