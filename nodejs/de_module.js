        ...
        try {
            ...
            if (jMsg[INTERMODULE_ROUTING_TYPE] === CMD_TYPE_INTERMODULE) {
                ...
                if (messageType === TYPE_AndruavModule_ID) {
                    ...
                    if (!moduleID || !(ANDRUAV_PROTOCOL_SENDER in moduleID) || !(ANDRUAV_PROTOCOL_GROUP_ID in moduleID)) {
                        return;
                    }
